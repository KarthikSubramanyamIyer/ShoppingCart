<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeBehind="AddSize.aspx.cs" Inherits="Shoppingv2.AddSize" %>
                ...
                <div class ="form-group">
                 ...
                 <div class ="form-group">
                    ...
                    <div class ="col-md-3 ">
                        ...
                        <asp:DropDownList ID="ddlCategory" CssClass ="form-control" runat="server" OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged"  ></asp:DropDownList>
